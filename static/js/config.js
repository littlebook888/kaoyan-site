...
window.APP_CONFIG = {
   ...
   * 2026.09.13 起按《陈本祯规则部考研时间安排计划表》执行：
   * 早块 = 上午自习 8:00~12:00；午块 = 午餐后 12:00~18:00（含午休）；晚块 = 晚自习 18:30~24:00
   * 改这里即可调整你的作息边界（24 小时制 HH:MM，支持 "24:00" 表示午夜）。 */
  TIME_BLOCKS: {
    wake:   "08:00",   // 上午自习起点（起床：实习日及一般情况 7:30；非实习日 8h 睡眠制度、起床困难时 9:00~9:30，仅作息对照，不入配置）
    lunch:  "12:00",   // 午餐（早块结束 / 午块起点）
    dinner: "18:00",   // 晚餐（午块结束 / 晚块起点）
    sleep:  "24:00"    // 夜间学习结束（晚块终点）
  },
