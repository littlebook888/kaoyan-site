...
const groups = [
  ...
  choiceGroup({
    id: 'surgery-general-core-n03a', title: '营养代谢·营养制剂', lecture: 32, page: 2,
    options: [
      '组件型：适合特殊需求者', '糖尿病：减少葡萄糖、增加脂肪乳剂量',
      '慢性肾衰：低磷、低蛋白，不需限制糖', '回肠肠瘘',
      '胰腺炎', '要素型以氨基酸、多肽等为主，残渣少，无需消化即可吸收，不含乳糖',
      '非要素型或整蛋白型：等渗、口感好、最常用', '短肠综合征',
    ],
    stems: [['非要素型', ['G']], ['要素型', ['D', 'E', 'F', 'H']], ['组件型', ['A']], ['疾病专用型', ['B', 'C']]],
  }),
  choiceGroup({
    id: 'surgery-general-core-n03b', title: '营养代谢·特殊营养补充', lecture: 32, page: 2,
    options: ['谷氨酰胺营养肠黏膜细胞', '肝功能不全加用支链氨基酸'],
    stems: [['谷氨酰胺', ['A']], ['支链氨基酸', ['B']]],
  }),
  fillGroup({
    id: 'surgery-general-core-n03c', title: '营养代谢·营养液配制', lecture: 32, page: 2, inputMode: 'text',
    stems: [['营养液中不允许添加____。', ['其他药物']]],
  }),
  choiceGroup({
